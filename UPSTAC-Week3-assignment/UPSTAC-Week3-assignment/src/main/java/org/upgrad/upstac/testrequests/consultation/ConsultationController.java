...
public class ConsultationController {
    ...
    public TestRequest assignForConsultation(@PathVariable Long id) {
        ...
        //Create an object of TestRequest class and use the assignForConsultation() method of
        // testRequestUpdateService to assign the particular id to the current user
    ...
    public TestRequest updateConsultation(@PathVariable Long id,@RequestBody CreateConsultationRequest testResult) {
        ...
        // Create an object of TestRequest class and make use of updateConsultation() method
        // from testRequestUpdateService class
